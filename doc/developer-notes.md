...
- ThreadSocketHandler : Sends/Receives data from peers on port 32552.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 32551 for connections and services them.

- FlopcoinMiner : Generates flopcoins (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:flopcoin/flopcoin.git
