...
Flopcoin Core 1.8.1 is primarily a bugfix release, bringing Flopcoin Core in
line with Bitcoin 0.9.3. Flopcoin Core 1.8.1 also adds in support for printing
...
* Disable Transifex based translation process (not used by Flopcoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Flopcoin Core clients
* Use HTTPS with flopchain.info
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/flopcoin/flopcoin/issues/134).
