...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        inputs  = [ {'txid' : utx['txid'], 'vout' : utx['vout']}]
        # Flopcoin: Fee is exact, do not use tolerance
        ...
        inputs  = [ {'txid' : utx['txid'], 'vout' : utx['vout']} ]
        # Flopcoin: Reduce this output so the fee doesn't leave us with no change
        ...
        inputs = []
        # Flopcoin: TX size rounding gives us a fee of 4 FLOP
        ...
        # output 0 takes at least as much share of the fee, and no more than 2 florinss more, than outputs 2 and 3
