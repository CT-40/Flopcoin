...
import RPC call and node 0 sends Flopcoin to it. Then other nodes import the
...
In the second part of the test, node 0 sends more Flopcoin to each address, and the
