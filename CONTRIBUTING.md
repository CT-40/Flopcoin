# Contributing to Flopcoin Core

Flopcoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/Flopcoin/Flopcoin/labels/help%20wanted)
* [Projects](https://github.com/Flopcoin/Flopcoin/projects)
* [Flopcoindev on reddit](https://www.reddit.com/r/flopcoindev/)

## Branch Strategy

Flopcoin Core's default branch is intentionally a stable release, so that anyone
...
Flopcoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Flopcoin Core
releases will automatically benefit from these.

When refactoring Flopcoin-specific code, please keep refactoring requests short,
...
The following applies to code changes to Flopcoin Core, and is not to be
confused with overall Flopcoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Flopcoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Flopcoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Flopcoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Flopcoin consensus, it must have been
