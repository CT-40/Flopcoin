...
void Shutdown()
{
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Flopcoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Flopcoin/Flopcoin>";
    const std::string URL_WEBSITE = "<https://flopcoin.net>";
...
bool AppInitParameterInteraction()
{
    ...
    // 1-florin-fee transactions. It should be set above the real
    ...
    // This is the maximum absolute fee (in COIN, not florins)
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Flopcoin: Do we need to do any RPC mining init here?
