...
const char * const BITCOIN_CONF_FILENAME = "flopcoin.conf";
const char * const BITCOIN_PID_FILENAME = "flopcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Flopcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Flopcoin";
#else
    // Unix
    return pathRet / ".flopcoin";
#endif
#endif
}
