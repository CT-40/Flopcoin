...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Flopcoin Core repository on GitHub"),
        tr("Services that claim to double your flopcoins are always ponzi schemes")
    };
