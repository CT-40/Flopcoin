...
{
    GUIUtil::restoreWindowGeometry("nWindow", QSize(1000, 647), this);

    //this->setFixedSize(QSize(1000, 647));
    ...
    QFont newFont("infoma", 9);

    // Flopcoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Flopcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Flopcoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Flopcoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Flopcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Flopcoin"); // default title
