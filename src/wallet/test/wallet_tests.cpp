...
BOOST_AUTO_TEST_CASE(coin_selection_tests)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        // run the 'mtgox' test (see https://explorer.flopcoin.net/tx/1b17a71556cbe808f1839fdb9e552abc793bf580ef73ef690f399acad1403dd3)
...
{
    uint64_t value = 1000 * COIN; // 1,000 FLOP
