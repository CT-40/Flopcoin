 ...
 *
 *  Flopcoin:    Increment mempool limits and accept RBF in steps of 0.0001 FLOP
...
/**
 * Flopcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Flopcoin: Default hard dust limit that is evaluated when considering whether
