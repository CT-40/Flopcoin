...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s flopcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  flopcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flopcoin transaction") + "\n" +
              "  flopcoin-tx [options] -create [commands]   " + _("Create hex-encoded flopcoin transaction") + "\n" +
              "\n";
